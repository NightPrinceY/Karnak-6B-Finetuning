...
build_lora_dataset_v5.py: NAMED_VERSES (ayah nicknames) and ALT_SURAH_NAMES
...
# OR run this AFTER build_lora_dataset_v5.py and diff manually).
NAMED_VERSES = [
...
ALT_SURAH_NAMES = [
    ...
    ("هل أتى", 76),
    ("قل هو الله أحد", 112),
    # v5 additions -- systematically re-derived from real scholarly text
    # (see dataset/build_lora_dataset_v5.py's ALT_SURAH_NAMES block for the
    # extraction methodology and hand-curation rationale)
    ("فاتحة الكتاب", 1),
